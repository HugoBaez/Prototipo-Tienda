...
public class mostrarRO extends JFrame {
	...
	public mostrarRO() {
		...
		JLabel lblNewLabel_2_1 = new JLabel("<html><H2>Relaxed Fit Jeans Mezclilla</H2><p>ID: 32381234414 <P>  Disponible en tamaños extendidos de calidad superior, flexible duradero con estilo auténtico y comodidad durante todo el día mas logotipo y empaque de la nueva marca.<p>Precio reducido de <FONT color=\"red\"><s>1 049 $</s></FONT> a un 20% desde 849 $<html>", quake4, SwingConstants.LEFT);
